...
#define ARMA_AUX_LIBS /ssoft/spack/paien/v2/opt/spack/linux-rhel7-x86_E5v2_IntelIB/gcc-6.4.0/openblas-0.2.20-gjpsmh7vkmgwtqrodsfzsdl324vpv6y7/lib/libopenblas.so
